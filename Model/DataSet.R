...
# process: "ER" or "PR"
# start: "sparse" (only 1 edge connected) or "dense" (~20% edges connected) for the starting network 
# --------------------Output: -------------------
# -------------------
# Synthetic data ###
# -------------------
...
DataSet = function(N, M, param_val, rate_obs, process = "ER", start = "sparse"){
  p = param_val[1]
  q = param_val[2]
  gamma = param_val[3]
  alpha = param_val[4]
